...
<head>
    ...
    <title>{{ config('app.name', 'Islamia College') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Islamia College') }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <tr>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admession-form.create') }}">{{ __('Online Admissions') }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('financial-management') }}">{{ __('Financial Management') }}</a>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('contact-us.create') }}">{{ __('Contact Us') }}</a>
                            </li>
                            @endif
                        </tr>    
                    </ul>
